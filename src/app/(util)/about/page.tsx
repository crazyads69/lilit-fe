            ...
            <Layout className="relative flex min-h-screen w-full flex-col bg-opacity-80 backdrop-blur-sm">
                ...
                <Content className="px-4 py-12 md:px-8 lg:px-16">
                        ...
                        <Flex className="flex-wrap justify-center" gap={24}>
                            ...
                            >
                                <Paragraph className="text-lg">
                                    Trở thành nền tảng truyện online hàng đầu Việt Nam, nơi mà viết
                                    lách được coi là một nghề nghiệp nghiêm túc, có thể tạo ra thu
                                    nhập ổn định và được xã hội tôn trọng.
                                </Paragraph>
                            </Card>
                            <Card
                                hoverable
                            ...
                            >
                                <Paragraph className="text-lg">
                                    Tạo ra một hệ sinh thái truyện số, kết nối độc giả, tác giả và
                                    nhà xuất bản, đồng thời bảo vệ quyền lợi của các bên tham gia
                    ...
                    <Flex vertical align="center" className="mb-24">
                        ...
                        <Card hoverable className="w-full max-w-4xl shadow-lg">
                            <Paragraph className="mb-6 text-lg">
                                LILIT ra đời từ niềm đam mê truyện và công nghệ của một nhóm lập
                                trình viên. Chúng tôi nhận thấy những hạn chế của các nền tảng
                                truyện hiện có như quảng cáo gây phiền nhiễu, phí premium cao, cơ
                                chế nạp phí rắc rối và sự bảo vệ bản quyền chưa đầy đủ.
                            </Paragraph>
                            <Paragraph className="mb-8 text-lg">
                                Với mong muốn tạo ra một không gian sáng tạo tự do và an toàn cho
                                cộng đồng yêu truyện, chúng tôi đã phát triển LILIT - một nền tảng
                                phi lợi nhuận, hoàn toàn miễn phí và không có quảng cáo.
                            </Paragraph>
                            <Divider />
                    ...
                    <Flex vertical align="center" className="mb-24">
                        ...
                        <Card hoverable className="w-full max-w-4xl shadow-lg">
                            <Paragraph className="mb-6 text-lg">
                                LILIT hoạt động dựa trên nguyên tắc phi lợi nhuận, với mục tiêu duy
                                nhất là phục vụ cộng đồng yêu truyện. Chúng tôi duy trì hoạt động
                                thông qua:
                            </Paragraph>
                            <List
                                dataSource={[
                            ...
                            <Paragraph className="mt-6 text-lg">
                                Mọi khoản thu nhập đều được sử dụng để duy trì và phát triển nền
                                tảng, cũng như hỗ trợ cộng đồng tác giả.
                            </Paragraph>
                        </Card>
                    </Flex>
                    ...
                    <Flex vertical align="center" className="mb-24">
                        ...
                        <Card hoverable className="w-full max-w-4xl shadow-lg">
                            <Paragraph className="mb-6 text-lg">
                                ...
                                những người yêu truyện, với sự hỗ trợ của cộng đồng tình nguyện
                                viên. Chúng tôi là:
                            </Paragraph>
                            <List
                                dataSource={[
                            ...
                            />
                            <Paragraph className="mt-6 text-lg">
                                Chúng tôi luôn tìm kiếm những cá nhân tài năng và đam mê để gia nhập
                                đội ngũ LILIT. Nếu bạn quan tâm, hãy liên hệ với chúng tôi qua
                                email:{" "}
                                <Link
                    ...
                    <Flex vertical align="center" className="mb-24">
                        ...
                        <Card hoverable className="w-full max-w-4xl shadow-lg">
                            <Paragraph className="mb-6 text-lg">
                                LILIT tự hào hợp tác với nhiều đối tác trong ngành xuất bản và công
                                nghệ để mang lại trải nghiệm tốt nhất cho người dùng:
                            </Paragraph>
                            <List
                                dataSource={[
                            ...
                            />
                            <Paragraph className="mt-6 text-lg">
                                Chúng tôi luôn mở rộng cơ hội hợp tác để phát triển nền tảng và hỗ
                                trợ cộng đồng truyện. Nếu bạn quan tâm đến việc hợp tác, vui lòng
                                liên hệ:{" "}
                                <Link
                                    className="text-blue-600 hover:underline"
                                    href="mailto:lilit.official@outlook.com"
                    ...
                    <Flex vertical align="center" className="mb-24">
                        ...
                        <Card hoverable className="w-full max-w-4xl shadow-lg">
                            <Paragraph className="mb-6 text-lg">
                                Chúng tôi luôn sẵn sàng lắng nghe ý kiến đóng góp và giải đáp thắc
                                mắc của bạn. Hãy liên hệ với LILIT qua:
                            </Paragraph>
                            <List
                                dataSource={[
                                    {
